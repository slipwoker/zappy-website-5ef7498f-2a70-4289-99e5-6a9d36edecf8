document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        ...
        contactForm.addEventListener('input', function(e) {
            ...
            if (!input.matches('[name="name"], [name="email"], [name="message"]')) return;
            
            if (input.value.trim()) {
                if (input.name === 'email' && !validateEmail(input.value.trim())) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '5ef7498f-2a70-4289-99e5-6a9d36edecf8',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '5ef7498f-2a70-4289-99e5-6a9d36edecf8';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '5ef7498f-2a70-4289-99e5-6a9d36edecf8';
